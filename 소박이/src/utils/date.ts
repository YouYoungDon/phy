...
// Korean-format date — "2026년 5월 26일" — for the home today-surface overlay.
// Plain non-padded month/day (no leading zeros), matching how Korean dates are
// written in everyday memo / handwritten contexts. Pure: no locale config, no Intl.
export function formatKoreanYearMonthDay(date: Date): string {
